...
class Admin:
    ...
    async def slowmode(self, ctx, delay: str):
        ...
        await self.bot.say("This channel is now in :snail: slow mode :snail:. ({} seconds).".format(delay))
    ...
    async def slowoff(self, ctx):
        ...
        await self.bot.say("This channel is no longer in :snail: slow mode :snail: .")
